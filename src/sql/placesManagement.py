...
def createPlace(sqlHandler, name, latitude, longitude, workplace=False):
    """
...
def getPlaceById(sqlHandler, placeId):
    """
...
def isWorkplace(sqlHandler, placeId):
    """
...
def getAllWorkplaces(sqlHandler):
    """
...
def getAllNonWorkplaces(sqlHandler):
    """
...
def updatePlace(sqlHandler, placeId, newName=None, newLatitude=None, newLongitude=None, newWorkplace=None):
    """
...
def deletePlace(sqlHandler, placeId):
    """
